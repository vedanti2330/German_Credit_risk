...
def load_model():
    ...
    try:
        model = joblib.load('best_credit_risk_model-1.pkl')
        return model
    except FileNotFoundError:
        st.error("Model file 'best_credit_risk_model-1.pkl' not found. Please ensure it's in the same directory.")
        return None
...
def main():
    ...
    st.write("Enter the applicant's details to predict their credit risk. This app uses a Logistic Regression model trained on the German Credit Data.")
